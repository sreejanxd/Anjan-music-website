    ...
    return (
        <footer className="py-10 mt-10 text-center">
            ...
            <ul className="flex gap-1 items-center justify-center mt-1">
                ...
                <li><a className="text-xs bg-secondary hover:bg-primary hover:text-white rounded-full p-1 px-2" href="https://github.com/Siliguri-design" target="_blank">Github</a></li>
            </ul>
        </footer>
    )
}
